...
<div id="resultbox" class="sc_col_one left"><!-- <?php echo $thiscountry;?> - <?php echo $thisregion;?> -->
	<h1 style="margin-bottom:0px;"><a href="<?php echo site_url().'/'.$thiscountry.'/'.$thisregion;?>"><?php echo ucfirst($thisregion);?></a> &gt; <?php echo ucwords($thiscity);?></h1>
	...
	<?php if ($thiscity != '') { ?>
		...
		echo "<a href='".site_url()."/".$thiscountry."/".$thisregion."/".strtolower($value)."' style='color:black; text-decoration:none;'>".$value."</a> ";
		?>
		</h4>
	<?php } else { ?>
